<div class="mt-8">
    @auth
        <div>
            <p style="margin-bottom: 20px">Hey there! Let's free your mind!</p>
        <a href="{{ url('/posts') }}" class="font-bold text-gray-800 bg-yellow-400 hover:bg-yellow-500 px-6 py-3 rounded-md" style="background-color: #FFD43B;">Home</a>
